...
class Login(QDialog):
    def __init__(self):
        ...
        self.nivel = ""
        self.btnSenha.stateChanged.connect(self.mostrarSenha)

    def mostrarSenha(self):
        if self.btnSenha.isChecked():
...
class MainSelect(QtWidgets.QMainWindow):
    ...
    def mainJoin(self, conn, tableWidget):
        ...
        if chaveEstrangeira is not None:
            ...
            self.labOp.setText("Erro ao realizar a consulta relacionada. Tente inverter a ordem das tabelas.")
        ...
        if resposta == QMessageBox.Yes:
            try:
                    ...
                    if self.table == "Aluno":
                        ...
                        #sql2 = f"insert into id_funcionarios values (null, {idF}, null, {null}, {self.table}, {})"
...
connection = SQLOps.conectarBD("localhost", "root", "admin", "techmark", "3306")
